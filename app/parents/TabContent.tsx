...
import { SnackSignupModal } from './SnackSignupModal';
import type { Team, Player, Game, SnackSignup, TeamNews, PlayerRecognition } from '@/lib/supabase';
...
type TabContentProps = {
  ...
  games: GameWithSignups[];
  teamNews: TeamNews[];
  recognitions: any[];
};

export function TabContent({ team, players, games, teamNews, recognitions }: TabContentProps) {
